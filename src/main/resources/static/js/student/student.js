...
function editor(form, data) {
    ...
    form.val("editorForm", {
        ...
        "sex": isNull ? null : data.sex,
        "idCard": isNull ? null : data.idCard,
        "phone": isNull ? null : data.phone,
        "email": isNull ? null : data.email,
        "faculty": isNull ? null : data.faculty,
        "major": isNull ? null : data.major,
...
function list(t) {
    t.rander({
        ...
        cols: [[
            ...
            {field: 'sexDesc', title: '性别', align: 'center', width: 60},
            {field: 'idCard', title: '身份证', align: 'center', width: 175},
            {field: 'phone', title: '电话', align: 'center'},
            {field: 'email', title: '邮箱', align: 'center'},
            {field: 'faculty', title: '院系', align: 'center', width: 100},
